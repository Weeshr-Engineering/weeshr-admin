        ...
        <CardDescription>
          ...
          <div v-else-if="appUser">
            ...
            <div class='rounded-lg flex flex-col lg:mx-4 border shadow-md'>
                  <div
                  class="w-full flex justify-between shadow-md rounded-lg border px-4 md:px-6 py-1 my-2"
                >
                  ...
                  >
                  <!-- verified badge -->
                  <svg v-if='appUser.emailVerified' width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <!-- featured tag -->
                  <svg v-if='isFeatured' width="57" height="28" viewBox="0 0 77 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <!-- Influencer tag -->
                  <svg v-if='isInfluencer' width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect width="28" height="28" rx="14" fill="#C6EDF6"/>
                    <path d="M13.064 19V9.2H14.674V19H13.064Z" fill="#020721"/>
                  </svg>
                  <!-- Public figure -->
                  <svg v-if='isPublicFigure' width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class='w-full grid grid-cols-2 px-4 gap-2 my-4'>
                    <div class='col-span-2 md:col-span-1 flex items-center justify-between px-2'>Public Figure <Switch v-model='isPublicFigure' @click='()=> isPublicFigure = !isPublicFigure'/></div>
                    <div class='col-span-2 md:col-span-1 flex items-center justify-between px-2'>Influencer <Switch v-model='isInfluencer' @click='()=> isInfluencer = !isInfluencer'/></div>
                    <div class='col-span-2 md:col-span-1 flex items-center justify-between px-2'>Featured <Switch v-model='isFeatured' @click='()=> isFeatured = !isFeatured'/></div>
                    <div class='col-span-2 md:col-span-1 flex items-center justify-between px-2'>Verified <Switch :checked='appUser.emailVerified'/></div>
                </div>
            </div>
          </div>
        </CardDescription>
