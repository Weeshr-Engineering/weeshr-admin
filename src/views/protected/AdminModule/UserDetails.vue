          ...
          <div v-else-if="appUser">
            ...
            >
              ...
              <label
                ...
                @click="() => togglePrivacy(appUser?.settings.isProfilePublic!)"
              >
                <input
                  type="checkbox"
                  value=""
                  :checked="!appUser.settings.isProfilePublic"
                  disabled
                  class="peer sr-only"
                />
                <div
            ...
            <div class="rounded-lg flex flex-col lg:mx-4 border shadow-md">
              <div class="w-full flex justify-between rounded-lg px-4 md:px-6 py-1 my-2">
                ...
                >
                  <!-- verified badge -->
                  <svg
                    v-if="appUser.statusBadge.verified"
                    width="28"
                    height="28"
                    viewBox="0 0 28 28"
                    fill="none"
                  ...
                  <!-- featured tag -->
                  <svg
                    v-if="appUser.statusBadge.featured"
                    width="57"
                    height="28"
                    viewBox="0 0 77 28"
                    fill="none"
                  ...
                  <!-- Public figure -->
                  <svg
                    v-if="appUser.statusBadge.public_figure"
                    width="28"
                    height="28"
                    viewBox="0 0 28 28"
                    fill="none"
              ...
              <div class="w-full grid grid-cols-2 px-4 gap-2 mb-2">
                <div class="col-span-2 md:col-span-1 flex items-center justify-between px-2">
                  Public Figure
                  <Switch
                    :disabled="!update"
                    :checked="appUser.statusBadge.public_figure"
                    @click="() => toggleUserStatus('public_figure', _id)"
                  />
                </div>
                <div class="col-span-2 md:col-span-1 flex items-center justify-between px-2">
                  Influencer
                  <Switch
                    :disabled="!update"
                    :checked="appUser.statusBadge.influencer"
                    @click="() => toggleUserStatus('influencer', _id)"
                  />
                </div>
                <div class="col-span-2 md:col-span-1 flex items-center justify-between px-2">
                  Featured
                  <Switch
                    :disabled="!update"
                    :checked="appUser.statusBadge.featured"
                    @click="() => toggleUserStatus('featured', _id)"
                  />
                </div>
                <div class="col-span-2 md:col-span-1 flex items-center justify-between px-2">
                  Verified
                  <Switch
                    :disabled="!update"
                    :checked="appUser.statusBadge.verified"
                    @click="() => toggleUserStatus('verified', _id)"
                  />
                </div>
              </div>
            </div>
