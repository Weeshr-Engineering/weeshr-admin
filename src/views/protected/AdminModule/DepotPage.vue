<template >
    <div class="flex-col flex bg-[#f0f8ff] h-full px-4 sm:px-10 pb-10">
        ...
        <div class="w-full grid gap-4  md:grid-cols-4 md:gap-6 lg:grid-cols-8">
          <Button class="bg-[#020721] text-l font-medium text-[#FFFFFF] rounded-3xl min-w-[145px] h-[30px] md:h-[60px]">
            Today
          </Button>
          <Button class="bg-[#FFFFFF] text-l font-medium text-[#020721] rounded-3xl min-w-[145px] h-[30px] md:h-[60px]">
            6 Feb 2023
          </Button>
          <Button class="bg-[#FFFFFF] text-l font-medium text-[#020721] rounded-3xl min-w-[145px] h-[30px] md:h-[60px]">
            7 Feb 2023
            ...
            <Card class="h-[150px] rounded-[24px] transition-transform transform hover:scale-105 bg-[#FFFFFF] cardShadow1 border-transparent ">
                <div class="h-[130px] pt-4 relative rounded-tr-[24px] rounded-tl-[24px]">
                    <CardContent class="flex items-center justify-between space-y-0">
                        <p class="text-l font-medium text-[#020721]">Total Deliverable</p>
                        <div class="weeshr-icon1 rounded-[7px]">
                          <Icon icon="codicon:note" width="24px" height="24px" color="#ffffff" />
                        </div>
                        <p class="text-2xl lg:text-3xl font-medium text-[#020721] absolute bottom-2 left-5">56</p>
                    </CardContent>
                </div>
                <div class="border-b-8 border-[#FFFFFF] w-[202px] pt-5 md:pt:6 lg:pt-7   mx-auto rounded  "></div>
            </Card>

          
         
            
            <Card class="h-[150px] rounded-[24px] transition-transform transform hover:scale-105 bg-[#00C37F] cardShadow2 border-transparent ">
                <div class="h-[130px] pt-4 relative rounded-tr-[24px] rounded-tl-[24px]">
                    <CardContent class="flex items-center justify-between space-y-0">
                        <p class="text-l font-medium text-[#ffffff]">Delieved</p>
                        <div class="weeshr-icon2 rounded-[7px]">
                          <Icon icon="codicon:note" width="24px" height="24px" color="#00C37F" />
                        </div>
  
                        <p class="text-2xl lg:text-3xl font-medium text-[#ffffff] absolute bottom-2 left-5">19</p>
                    </CardContent>
                </div>
                <div class="border-b-8 border-[#00C37F] w-[202px] pt-5 md:pt:6 lg:pt-7   mx-auto rounded  "></div>

            </Card>

         
            <Card class="h-[150px] rounded-[24px] transition-transform transform hover:scale-105 bg-[#EE9F39] cardShadow3 border-transparent ">
                <div class="h-[130px] pt-4 relative rounded-tr-[24px] rounded-tl-[24px]">
                    <CardContent class="flex items-center justify-between space-y-0">
                        <p class="text-l font-medium text-[#ffffff]">Outbounded</p>
                        <div class="weeshr-icon2 rounded-[7px]">
                          <Icon icon="codicon:note" width="24px" height="24px" color="#EE9F39" />
                        </div>
        
                        <p class="text-2xl lg:text-3xl font-medium text-[#ffffff] absolute bottom-2 left-5">27</p>
                    </CardContent>
              </div>
              <div class="border-b-8 border-[#EE9F39] w-[202px] pt-5 md:pt:6 lg:pt-7   mx-auto rounded  "></div>

            </Card>
       
         
            <Card class="h-[150px] rounded-[24px] transition-transform transform hover:scale-105 bg-[#E45044] cardShadow4 border-transparent ">
                <div class="h-[130px] pt-4 relative rounded-tr-[24px] rounded-tl-[24px]">
                    <CardContent class="flex items-center justify-between space-y-0">
                        <p class="text-l font-medium text-[#ffffff]">Pending</p>
                        <div class="weeshr-icon2 rounded-[7px]">
                          <Icon icon="codicon:note" width="24px" height="24px" color="#E45044" />
                        </div>
        
                        <p class="text-2xl lg:text-3xl font-medium text-[#ffffff] absolute bottom-2 left-5">10</p>
                    </CardContent>
                </div>
                <div class="border-b-8 border-[#E45044] w-[202px] pt-5 md:pt:6 lg:pt-7   mx-auto rounded  ">
        ...
        <div class="flex flex-col sm:flex-row items-center justify-between py-4">
            <div class="text-xl sm:text-xl font-bold tracking-tight text-[#020721] mb-2 sm:mb-0">
              Total Depot Listing
            <p class="text-xs sm:text-sm font-normal text-[#02072199]">Manage all fulfilled weeshes</p>
          </div>
...
.cardShadow4 {
  box-shadow: 0px 31px 30px -23px #E45044,inset 0px -23px 20px -23px rgba(0, 0, 0, 0.25);
}
.weeshr-icon1 {
