            ...
            <form class="space-y-4" @submit="onSubmit">
              <FormField v-slot="{ componentField }" name="vendor">
                <FormItem v-auto-animate>
                  ...
                  <FormControl>
                    <Input id="text" type="text" placeholder="Vendor Name" class="focus-visible:ring-blue-600"
              ...
              <FormField v-slot="{ componentField }" name="phone">
                <FormItem v-auto-animate>
                  ...
                  <FormControl>
                    <vue-tel-input mode="international" id="phone" type="tel" placeholder="Last Name"
              ...
              <FormField v-slot="{ componentField }" name="category">
                <FormItem>
                  ...
                  <select v-bind="componentField" id="category"
